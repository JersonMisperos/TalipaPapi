			...
			<div class="col-75">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<label for="cname">Home Address</label>
						<input type="text" id="adr" name="address" class="form-control" value="'.$row["address1"].'" required>
						<div class="form-group" id="card-number-field">
						<a class="image-link" href="product_images/odn.jpg"target="_blank">---------------------->CLICK FOR GCASH PAYMENT<----------------------</a>
                        <img src="product_images/talili.png" class="responsive">
                        <input type="text"  placeholder="GCASH NAME" required>
                    </div>
